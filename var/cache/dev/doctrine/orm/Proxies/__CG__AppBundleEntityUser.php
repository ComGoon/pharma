...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'dateAdd', 'name', 'firstName', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'phoneNumber', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'cin', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'media', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
