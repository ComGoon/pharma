...
$c->setOptions(array('default_target_path' => 'homepage', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
